					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="<%=basePath%>views/myCart.jsp"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								<li><a href="<%=basePath%>views/register.jsp"><i class="fa fa-crosshairs"></i> Register</a></li>
								<li><a href="<%=basePath%>views/login.jsp"><i class="fa fa-lock"></i> Login</a></li>
								<li><a href="<%=basePath%>loginOutServlet"><i class="fa fa-unlock"></i> Logout</a></li>
							</ul>
						</div>
					</div>
				</div>
